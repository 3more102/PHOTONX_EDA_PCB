...
def test_native_benchmark_cli_fails_closed_when_backend_is_unavailable(
    ...
    assert stdout_report["native_available"] is False
    assert stdout_report["error_type"] == "NativeBackendUnavailable"
