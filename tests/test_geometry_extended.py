...
def test_board_bounds():
 board=BoardModel(tracks=[Track("T0",Point(0,0),Point(5,0),.2,"F.Cu")],pads=[PadCandidate("P0",Point(2,3),1,1,"C","F.Cu")]); b=board_bounds(board); assert b.max_y==3 and b.max_x==5
