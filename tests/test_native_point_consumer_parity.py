...
def test_point_consumers_can_force_python_reference_backend():
    pads = _pads()
...
def test_point_consumers_reject_unknown_backend():
    with pytest.raises(ValueError, match="backend"):
        cluster_pads(_pads(), 1.0, spatial_backend="gpu")
...
def test_point_consumers_native_backend_matches_python_reference():
    pads = _pads()
