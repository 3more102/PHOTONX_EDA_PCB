...
def _write(tmp_path: Path, text: str) -> Path:
    path = tmp_path / "macro_semantics.gtl"
...
def test_undefined_longer_variable_does_not_alias_shorter_parameter():
    statements = parse_macro_body("1,1,$10+0.8,0,0")
...
def test_macro_variable_zero_index_definition_is_invalid():
