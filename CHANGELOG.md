...
- Hardened board-outline validation to reject interior crossings and overlapping/duplicate outline segments as `OUTLINE_SELF_INTERSECTION`, while preserving ordinary shared-endpoint joints and disjoint closed loops used for cutout-style geometry.
