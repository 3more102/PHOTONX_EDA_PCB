...
- Added bounded dark Gerber G36/G37 region reconstruction as copper polygons, initially for single linear contours and later extended to G75 circular boundaries and multiple contours; cut-in holes, clear-polarity, and Edge.Cuts regions remain fail-closed.
