...
- Hardened core mechanical-slot validation to reject non-finite widths and coordinates, keeping `validate_board()` aligned with geometry checks instead of allowing NaN/Inf slot evidence downstream.
