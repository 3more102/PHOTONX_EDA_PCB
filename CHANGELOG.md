...
- Fixed Excellon program termination so `M30` and `M00` stop production parsing; trailing post-program coordinates or unsupported statements are no longer reconstructed or diagnosed as active program content.
