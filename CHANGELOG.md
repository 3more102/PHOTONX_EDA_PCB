...
- Hardened KiCad board net identity handling: net-table ordinals plus segment, via, and pad net references must remain integer-valued, duplicate net ordinals fail explicitly, and references to undefined net ordinals are rejected instead of being silently coerced or accepted.
