...
- Enforced XNC `M30` end-of-file semantics in the Excellon parser: non-empty data after `M30` is rejected in strict mode, permissive mode suppresses file geometry and records `INVALID_EXCELLON_DATA_AFTER_M30`, and regression/preflight coverage preserves valid termination and blank-tail handling.
