...
- Added exact reduction of single positive origin-centered, zero-rotation, axis-aligned Code-20 vector-line Gerber macros to rectangular apertures; diagonal, offset, rotated, zero-width, and zero-length cases remain fail-closed.
