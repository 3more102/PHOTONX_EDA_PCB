...
This stage removes repeated grid construction and box marshaling from hot paths while keeping the same safety boundary: native code only returns broad-phase candidates, and Python/exact geometry remains authoritative.
...
3. native build/packaging telemetry and fallback diagnostics;
