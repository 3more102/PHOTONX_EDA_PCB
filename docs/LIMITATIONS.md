...
- single positive Code-5 regular-polygon aperture macros with 3–12 integer vertices, positive diameter, origin-centered geometry, finite rotation, and parameterized modifiers, reduced exactly to standard P apertures so the supported P D03/D01/transform/composition path is reused;
