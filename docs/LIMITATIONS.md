...
- Excellon M30 end-of-file semantics: M30 terminates the program; any later non-empty command is invalid and fails closed so post-terminator drill, slot, or route data cannot enter reconstruction;
