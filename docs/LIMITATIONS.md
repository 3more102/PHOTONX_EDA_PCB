...
- single positive origin-centered Code-5 polygon aperture macros with integer 3–12 vertex count, positive circumscribed diameter, and finite rotation, reduced exactly to standard P apertures; macro rotation is preserved as P template rotation;
...
- ambiguous/invalid G74 center cases and complex aperture macros outside the exact single-primitive reduction subset; mixed-axis or otherwise invalid cut-ins, fully-coincident cut-ins that resolve to disjoint filled areas, LPC files containing outline material geometry, plus Edge.Cuts regions and aperture blocks, remain fail-closed rather than being approximated or leaked as ordinary geometry;
