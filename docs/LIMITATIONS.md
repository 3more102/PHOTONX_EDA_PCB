...
- deprecated Code-22 lower-left-line aperture macros reduced exactly to rectangular apertures only when positive-sized, zero-rotation, and lower-left positioned so the rectangle is centered at the macro origin;
