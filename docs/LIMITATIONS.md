...
- Gerber step-and-repeat expansion for supported linear geometry, with deterministic IDs, source provenance, and unit-aware offsets;
...
- Gerber aperture macros and aperture blocks when exact semantics are not implemented;
