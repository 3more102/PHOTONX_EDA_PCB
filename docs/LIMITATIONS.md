...
- Excellon M30 end-of-file semantics: M30 terminates the program, and any later non-empty command fails closed so trailing drill or route data cannot enter the reconstruction;
