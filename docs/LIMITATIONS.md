...
- ambiguous/invalid G74 center cases and complex aperture macros; mixed-axis or otherwise invalid cut-ins, fully-coincident cut-ins that resolve to disjoint filled areas, clear-polarity regions, Edge.Cuts regions, and aperture blocks remain fail-closed rather than being approximated or leaked as ordinary tracks/flashes;
