...
- Excellon tool definitions before explicit `METRIC/INCH/M71/M72` units, and later switches between metric and inch after units have already been declared: strict mode rejects them and permissive mode suppresses file geometry instead of assuming or mixing unit systems;
