...
- Excellon tool definitions before explicit `METRIC/INCH/M71/M72` units, or a later conflicting metric/inch unit declaration: strict mode rejects the file and permissive mode suppresses all file geometry instead of assuming or mixing unit systems;
