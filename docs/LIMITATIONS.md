...
- single positive Code-4 outline macros are reduced exactly when explicitly closed and representable as an origin-centered rectangle or centered regular 3–12 vertex polygon; these reuse standard R/P aperture paths, while irregular/non-centered outlines remain fail-closed;
...
- ambiguous/invalid G74 center cases and complex aperture macros outside the declared Code-4/Code-5 exact-reduction subsets; mixed-axis or otherwise invalid cut-ins, fully-coincident cut-ins that resolve to disjoint filled areas, LPC files containing outline material geometry, plus Edge.Cuts regions and aperture blocks, remain fail-closed rather than being approximated or leaked as ordinary geometry;
