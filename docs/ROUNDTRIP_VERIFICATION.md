...
- exporter-default zone-rule values that control repour behavior: connect-pad clearance, minimum thickness, thermal gap/bridge width, and island-removal mode;
