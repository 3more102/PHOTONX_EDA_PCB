...
- **Code 5 polygon:** exposure on, integer vertex count from 3 through 12, positive circumscribed-circle diameter, center at the macro origin, and any finite rotation. The primitive is reduced exactly to a standard P aperture, preserving the macro rotation as the P template rotation.
