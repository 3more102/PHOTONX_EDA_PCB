...
| Excellon program termination | **Implemented** | `M30` is the XNC end-of-file command; non-empty trailing commands are invalid, rejected in strict mode, and suppress permissive geometry |
