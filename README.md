...
| Excellon point drill hits | **Implemented** | Drill hits with explicit metric/inch units and positive tool diameters; undeclared-unit, conflicting metric/inch unit switches, and zero-diameter tools fail closed |
