...
|---|---|---|
| Gerber linear draws / flashes | **Partial** | Solid C/R/O flashes are supported. Circular D01 draws remain centerline tracks; rectangular D01 sweeps are exact CopperRegion polygons and obround D01 sweeps use deterministic 0.005 mm chord-error-bounded polygonization. Holed apertures and non-orthogonal R/O rotations fail closed |
...
| Gerber aperture transforms | **Partial** | Modal LM/LR/LS is exact for centered symmetric C/R/O geometry: mirror, positive scaling, arbitrary circle rotation, and orthogonal R/O flash or linear-sweep rotation; non-orthogonal R/O geometry fails closed |
