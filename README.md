...
| `--kicad` requested | PHOTONX writes the KiCad board plus `kicad_export_report.json`, `kicad_omissions.json`, `kicad_connectivity_roundtrip.json`, and a separate `kicad_validation.txt` native-validation result |
