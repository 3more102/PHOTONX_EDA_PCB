...
| Excellon program termination | **Implemented** | `M30` terminates the XNC/Excellon program; non-empty trailing commands are rejected in strict mode and suppress permissive geometry instead of leaking post-EOF data |
