...
| Excellon point drill hits | **Implemented** | Drill hits with explicit metric/inch units and finite positive tool diameters; undeclared-unit, duplicate-tool, undefined-selection, and invalid-diameter cases fail closed |
...
| Excellon program termination | **Implemented** | `M30` terminates the XNC/Excellon program; later non-comment commands are rejected in strict mode and suppress permissive geometry instead of leaking post-EOF data |
