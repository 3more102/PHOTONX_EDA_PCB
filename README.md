...
| Gerber regions / complex macros | **Partial** | Dark G36/G37 region statements support multiple closed contours with linear and G75 circular boundaries; contours are filled individually with union semantics and retain provenance, transforms, step-repeat, connectivity and validation; G74 region arcs, cut-in holes, clear-polarity, Edge.Cuts regions, aperture blocks, and complex macros remain fail-closed |
