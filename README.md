...
| Gerber simple aperture macros | **Partial** | Origin-centered circles and Code-5 regular polygons plus exact centered Code-20/Code-2 vector-line, Code-21 center-line, and deprecated Code-22 lower-left rectangles are reduced exactly to C/P/R apertures. Code-5 polygons require 3–12 vertices, positive diameter, origin-centered geometry and finite rotation; rectangle rotations remain limited to 90-degree steps |
