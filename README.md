...
| Gerber simple aperture macros | **Partial** | Origin-centered circles and Code-5 regular polygons plus exact centered Code-20/Code-2 vector-line, Code-21 center-line, and deprecated Code-22 lower-left rectangles are reduced to C/R/P apertures. Code-5 polygons support 3–12 vertices and finite rotation; rectangle rotations are supported only in 90-degree steps |
