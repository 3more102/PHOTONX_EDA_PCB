...
| Verified commit | **`9fb2a8d` — 19 Sep 2026** |
| CI matrix | Python **3.11**, **3.12**, **3.13** |
| Test result | **828 passed, 2 warnings** on each CI matrix job |
| CI run | [GitHub Actions run 35427509967](https://github.com/3more102/PHOTONX_EDA_PCB/actions/runs/35427509967) |
...
| Gerber simple aperture macros | **Partial** | Single positive origin-centered circles and zero-rotation Code-21 center-line rectangles are reduced exactly to C/R apertures |
...
For verified code commit **`9fb2a8d`**, each matrix job completed successfully with:

```text
828 passed, 2 warnings
```
...
[Open the verified workflow run](https://github.com/3more102/PHOTONX_EDA_PCB/actions/runs/35427509967).
...
- Single positive origin-centered circle macros and zero-rotation Code-21 center-line rectangle macros are supported as exact C/R apertures. Legacy G74 single-quadrant arcs are supported only for unsigned I/J distances when one center candidate is unambiguous and the sweep is at most 90°. Gerber regions and aperture blocks remain outside the declared production high-level parser and suppress file geometry in permissive mode; other complex aperture macros remain unsupported.
