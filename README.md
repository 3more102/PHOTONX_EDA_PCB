...
| Gerber regions / complex macros | **Partial** | Dark G36/G37 statements support multiple closed linear/G75 contours plus one bounded simple cut-in hole per contour using a fully-coincident opposite horizontal/vertical linear bridge pair; holes are explicit geometry and retain provenance, transforms, step-repeat, connectivity and validation. Multiple/disjoint cut-ins, G74 region arcs, clear-polarity, Edge.Cuts regions, aperture blocks, and complex macros remain fail-closed |
