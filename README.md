...
| Gerber C/R/O apertures | **Implemented subset** | Positive-size C/R/O apertures are modeled. A single centered round-hole modifier is supported for D03 flashes on material layers as transparent CopperRegion geometry; zero-size/non-fitting holes and holed D01/G02/G03 draws remain fail-closed |
