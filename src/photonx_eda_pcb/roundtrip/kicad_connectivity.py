...
def compare_kicad_connectivity(board, readback, export_report=None):
    ...
    recovered slots, and exact routed paths, including source-proven plated routed slots, exported as recovered route footprints. Proven plated via spans are exported only when their
