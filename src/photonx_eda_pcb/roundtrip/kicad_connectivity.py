...
def _electrical_partition_rows(families, issues, side):
    ...
    This audit is deliberately independent of copper geometry. It verifies the
    semantic partition KiCad will use after export: every emitted conductive
    artifact must remain bound to exactly the same exported net.
    """
    by_net = {}
    seen = {}
