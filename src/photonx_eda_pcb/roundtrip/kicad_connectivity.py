...
def compare_kicad_connectivity(board, readback, export_report=None):
    ...
    recovered slots, exact non-plated routed paths exported as NPTH route footprints, and source-proven plated routed slots. Proven plated via spans are exported only when their
