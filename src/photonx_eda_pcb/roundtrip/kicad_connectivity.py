...
def compare_kicad_connectivity(board, readback, export_report=None):
    ...
    annular geometry, complete layer support, reconstructed net, and via type are
    exactly representable; source-declared Blind/Buried X2 spans preserve their
    KiCad via type while untyped partial spans remain explicit source losses. Deterministic PhotonX UUIDs are part of the supported
