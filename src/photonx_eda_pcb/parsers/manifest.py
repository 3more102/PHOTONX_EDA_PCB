...
def discover_manufacturing_files(source: str | Path) -> list[ManufacturingFile]:
    ...
    A manufacturing package is no longer required to use conventional file
    extensions. Content signatures are preferred when available, while common
    CAM extensions remain supported for legacy packages.
    """
