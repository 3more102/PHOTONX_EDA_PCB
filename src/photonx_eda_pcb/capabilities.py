...
CAPABILITIES=[
    ...
    Capability("Excellon drill hits","implemented","Point hits with explicitly declared metric/inch units and tool diameters; tool definitions before unit declaration fail closed instead of assuming mm."),
