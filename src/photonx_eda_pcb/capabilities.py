...
CAPABILITIES=[
    ...
    Capability("Legacy Gerber compatibility","partial","Supports explicit MO or legacy G70/G71 units, absolute G90/FS-A and incremental G91/FS-I coordinates, standalone/modal D01/D02/D03 operations, UTF-8 BOM, exact MI coordinate mirroring, exact MO-unit OF image translation, exact IR rotations at 0/90/180/270 degrees, and identity SF/AS/IP. Transform order is MI -> SF -> OF -> IR independent of command appearance; unsupported AS/IP/SF semantics fail closed."),
