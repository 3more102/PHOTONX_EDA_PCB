...
CAPABILITIES=[
    ...
    Capability("Gerber layer polarity","partial","Dark LPD polarity is supported. LPC is supported for the polygon-exact subset consisting of supported G36/G37 regions plus rectangular D03 flashes: ordered dark/clear operations are composed deterministically and materialized back to CopperRegion shells/holes. Tracks, outline geometry, and circular/obround flashes remain fail-closed."),
