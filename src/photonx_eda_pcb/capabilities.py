...
CAPABILITIES=[
    ...
    Capability("Gerber G74 arcs/regions/macros","partial","Bounded G74 single-quadrant draws and dark-region circular boundaries are supported when one <=90-degree center candidate is unambiguous. Dark G36/G37 region statements support multiple explicitly closed contours with linear segments plus bounded G74 and G75 G02/G03 circular boundaries; each contour is filled individually and the statement has union semantics, with deterministic IDs, provenance, supported image transforms, and step-repeat. Unsupported cut-in topologies, clear-polarity, Edge.Cuts regions, aperture blocks, and complex macros remain fail-closed."),
