...
CAPABILITIES=[
    ...
    Capability("Legacy Gerber compatibility","partial","Supports explicit MO or legacy G70/G71 units, absolute G90/FS-A and incremental G91/FS-I coordinates, standalone/modal D01/D02/D03 operations, UTF-8 BOM, exact whole-image IR rotations at 0/90/180/270 degrees, and identity SF/AS/IP/MI/OF transforms; undeclared/conflicting units and non-identity AS/IP/MI/OF/SF transforms fail closed with permissive geometry suppression."),
