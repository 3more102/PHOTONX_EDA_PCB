...
CAPABILITIES=[
    ...
    Capability("Gerber circular arcs","partial","G75 multi-quadrant arcs use signed I/J offsets; bounded legacy G74 single-quadrant arcs resolve unsigned center distances only when one <=90-degree candidate is unambiguous. Circular apertures are tessellated deterministically with explicit provenance."),
    ...
    Capability("Gerber regions/complex macros","not_implemented","Regions, complex aperture macros, and aperture blocks remain rejected in strict mode."),
