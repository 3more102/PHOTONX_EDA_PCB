...
CAPABILITIES=[
    ...
    Capability("Gerber simple aperture macros","partial","Single positive origin-centered circle macros plus exact centered zero-rotation axis-aligned Code-20 vector-line and Code-21 center-line rectangles are reduced to standard C/R apertures; other macro geometry remains fail-closed."),
