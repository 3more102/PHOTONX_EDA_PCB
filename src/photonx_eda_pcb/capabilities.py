...
CAPABILITIES=[
    ...
    Capability("Gerber G74 arcs/regions/macros","partial","Bounded G74 single-quadrant draws are supported when one <=90-degree center candidate is unambiguous. Dark single-contour G36/G37 regions support linear segments plus G75 G02/G03 circular boundaries using deterministic chord-error-bounded tessellation, including incremental endpoints, supported image transforms, and step-repeat. G74 region arcs, multi-contour/hole, clear-polarity, Edge.Cuts regions, aperture blocks, and complex macros remain fail-closed."),
