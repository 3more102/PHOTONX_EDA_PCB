...
CAPABILITIES=[
    ...
    Capability("Excellon routed arcs","partial","G02/G03 routed arcs support I/J center offsets and bounded inline A# radius form for geometry with sweeps <=180 degrees; both are tessellated deterministically with explicit provenance."),
    Capability("Excellon slots/routes","partial","G85 straight slots plus G00/M15/G01 linear routing and bounded G02/G03 circular routed paths using I/J or inline A# radius definitions are supported."),
