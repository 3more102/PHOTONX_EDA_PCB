...
CAPABILITIES=[
    ...
    Capability("Legacy Gerber compatibility","partial","Supports G70/G71 units, G90 absolute mode, standalone/modal D01/D02/D03 operations, UTF-8 BOM, and identity legacy transforms; G91 incremental mode and non-identity AS/IP/MI/OF transforms remain fail-closed, with permissive geometry suppression."),
