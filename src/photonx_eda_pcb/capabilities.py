...
CAPABILITIES=[
    ...
    Capability("Legacy Gerber compatibility","partial","Supports explicit MO or legacy G70/G71 units, absolute G90/FS-A and incremental G91/FS-I coordinates, standalone/modal D01/D02/D03 operations, UTF-8 BOM, exact MI/OF/IR image transforms, both AS axis-select forms as output-device-only no-ops, IN/LN comment metadata, G55 no-op, M01 optional stop, and M00/M02 termination. Transform order is MI -> SF -> OF -> IR; unsupported IP/SF semantics fail closed."),
