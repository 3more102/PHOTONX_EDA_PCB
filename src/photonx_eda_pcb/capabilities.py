...
CAPABILITIES=[
    ...
    Capability("Gerber G74 arcs/regions/macros","partial","Bounded G74 single-quadrant arcs are supported when one <=90-degree center candidate is unambiguous. Dark single-contour linear G36/G37 regions are reconstructed as exact polygons with provenance, image transforms, and step-repeat; arc-bounded, multi-contour/hole, clear-polarity, Edge.Cuts regions, aperture blocks, and complex aperture macros remain fail-closed."),
