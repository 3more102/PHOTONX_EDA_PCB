...
CAPABILITIES=[
    ...
    Capability("Gerber layer polarity","partial","Dark LPD polarity is supported. An explicit deterministic ordered dark/clear image-operation model now provides the foundation for exact composition, but LPC parsing remains fail-closed until geometry boolean subtraction and board-model materialization are integrated end-to-end."),
