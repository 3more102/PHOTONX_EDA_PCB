...
from .confidence import object_review_context
...
class Inspector(tk.Text):
    ...
    def show(self, object_id: str | None):
        ...
        if object_id is None:
            self.insert("end", "Select a pad, track, or outline segment.\n")
        else:
            ...
            payload["review_context"] = object_review_context(self.state.board, object_id)
