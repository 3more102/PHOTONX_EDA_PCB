...
def summary(
    board: BoardModel, report: ValidationReport | None = None
) -> dict[str, object]:
    data = {
        ...
        "physical_nets": len(board.nets),
        "component_hypotheses": len(board.components),
        "parse_diagnostics": len(board.diagnostics),
    }
