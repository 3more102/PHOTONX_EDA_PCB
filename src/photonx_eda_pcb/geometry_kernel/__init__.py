...
from .regions import region_shape
...
__all__=["pad_shape","track_shape","drill_shape","region_shape","object_shape","GeometryTolerance","quantize_value","quantize_point","within_distance","covers_with_tolerance"]
